        ...
        <div className="container py-6">
            <div>
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 place-items-center'>
                    <div>
                    <h1 className='text-3xl pb-2'>Car Rental</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor ea eligendi aspernatur?</p>
                    ...
                    <div>
                        <h1 className='text-3xl pb-2'>Important links</h1>
